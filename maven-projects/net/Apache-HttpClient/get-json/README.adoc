...
├── junit-platform-commons-1.13.2.jar
...
[source,console]
----
$ java -cp target/get-json-1.0-SNAPSHOT.jar:target/dependency/httpclient5-5.5.jar:target/dependency/httpcore5-5.3.4.jar:target/dependency/httpcore5-h2-5.3.4.jar:target/dependency/jackson-annotations-2.21.jar:target/dependency/jackson-core-2.21.1.jar:target/dependency/jackson-databind-2.21.1.jar:target/dependency/slf4j-api-1.7.36.jar com.example.App
FakeRestApiAuthors [firstName=First Name 1, id=1, idBook=1, lastName=Last Name 1]
FakeRestApiAuthors [firstName=First Name 2, id=2, idBook=1, lastName=Last Name 2]
