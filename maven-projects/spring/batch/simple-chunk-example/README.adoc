...
├── spring-boot-starter-batch-3.0.2.jar
├── spring-boot-starter-data-jpa-3.0.2.jar
├── spring-boot-starter-jdbc-3.0.2.jar
├── spring-boot-starter-logging-3.0.2.jar
├── spring-boot-starter-test-3.0.2.jar
├── spring-boot-test-3.0.2.jar
├── spring-boot-test-autoconfigure-3.0.2.jar
